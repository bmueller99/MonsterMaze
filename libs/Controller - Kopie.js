            ...
            case "thirdPerson":
        		...
        		switch ( event.keyCode ) 
        		{
                    ...
                    case 49:
                        ...
                        tox = this.object.position.x;
                        toy = this.object.position.y;  
                        toz = this.object.position.z;
                    ...
                    case 50:
                        ...
                        //console.log("cam = " + cam.position.x + " *** " + cam.position.y + " *** " + cam.position.z );
...
//this.object.worldToLocal( this.object.position );
    ...
    this.updateCam = function( delta ) {
        ...
        //console.log( " camupdate mouseX " + actualLookSpeed );
        ...
        //console.log(" target x,y,z == " + targetPosition.x + "***" + targetPosition.y + "***" + targetPosition.z );
